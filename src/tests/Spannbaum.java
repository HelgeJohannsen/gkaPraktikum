...
public class Spannbaum {
	...
	public void testSpannBaum() {
		...
		Graph generated1 = fc.readFile("./src/graphDataOutput/", "generated1");

		Graph generated2 = fc.readFile("./src/graphDataOutput/", "generated2");

		Graph generated3 = fc.readFile("./src/graphDataOutput/", "generated3");

		Graph graph03 = fc.readFile("./src/graphDataOutput/", "graph03");

		Graph graph05 = fc.readFile("./src/graphDataOutput/", "graph05");
		// Test Prim
